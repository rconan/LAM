...
addpath('/home/mkonnik/matlab/OOMAO_LAM/oomao_raven/OOMAO-Raven')
...
% fixedLagTimeInMs = 3;
% strehl =  0.2119         0         0    0.2061
    
fixedLagTimeInMs = 0;
% strehl = 0.2416         0         0    0.2416

% fixedLagTimeInMs = 7;
%     strehl = 0.2335         0         0    0.2254
%% these simulations are for R band, 550 nm lightwave
...
% fixedLagTimeInMs = 0;
%%% the strehl is strehl = 0.2416

% fixedLagTimeInMs = 3;
% the strehl is strehl = 0.1248

% fixedLagTimeInMs = 7;
% the strehl is strehl =  0.1366         0         0    0.1347
% 
% EE =   0     0     0     0
...
% maxRadialDegree = 9; %% it was in the original code
maxRadialDegree = 3;
...
% maxRadialDegreeProj = 23; %%%% in the origianl code
maxRadialDegreeProj = 10; 
