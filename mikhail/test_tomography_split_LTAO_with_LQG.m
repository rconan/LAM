...
lgsAst_slmmse.warmStart = true;
 ...
 %% Linear Minimum Mean Square Error (LMMSE) wavefront reconstructor
TTAst_slmmse = slopesLinearMMSE(QuadCell, tel, atm, TTAst,'mmseStar',ngs,'NF',512);  
%%% Instead of this, we have to use the \Sigma_beta_alpha G^T ... 
...
%    %% Now add TT from TT stars, and use PI closed-loop controller for TT-loop:
    ...
    phase_TT = TTAst_slmmse*(QuadCell.slopes);
end
