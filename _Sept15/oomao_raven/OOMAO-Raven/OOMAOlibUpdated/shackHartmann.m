classdef shackHartmann < hgsetget
    ...
    methods
        ...
        function obj = shackHartmann(nLenslet,detectorResolution,minLightRatio)
            ...
            if isempty(obj.lenslets.nArray)
                       obj.p_referenceSlopes = ...
                repmat(obj.p_referenceSlopes,1,1);
            else     
            obj.p_referenceSlopes = ...
        ...
        function setValidLenslet(obj,mask)
        ...
        function varargout = dataProcessing(obj)
            ...
            buffer = obj.camera.frame;
%             for i = 1:nFrame
%             buffer(:,:,i) = buffer(:,:,i)';
%             end
            buffer = buffer(obj.indexRasterLenslet);
           % buffer     = obj.camera.frame(obj.indexRasterLenslet);
        ...
        function varargout = sparseGradientMatrix(obj,mask)
