...
REP = 'C:\Users\mgray\AO_HARMONI\PERT_TRANSIENT\VERSION_1_3\';
% REP = '/home/mgray/OA_HARMONI/PERT_DYNAMIQUES/VERSION_1_3/';
% REP = '/data/HARMONI/SCAO/ESO_ELT_R1.3/TEL-INS-IF';
...
if ROUT == 1 || ROUT == 2
    DiamExtNonVig = 38.542;
    % ZERNIKES sur le M1
    telM1 = telescope(DiamExtNonVig,'obstructionRatio',0,'resolution',nRes,'samplingTime',1/500);
    masq_telM1 = telM1.pupilLogical;
    ZernM1 = zernike(1:8,DiamExtNonVig,'resolution',nRes,'pupil',masq_telM1);
    TipM1 = CARTES_2DZER(ZernM1,2,nRes,masq_telM1);
    TiltM1 = CARTES_2DZER(ZernM1,3,nRes,masq_telM1);
    FocusM1 = CARTES_2DZER(ZernM1,4,nRes,masq_telM1);
    Ast0M1 = CARTES_2DZER(ZernM1,5,nRes,masq_telM1);
    Ast45M1 = CARTES_2DZER(ZernM1,6,nRes,masq_telM1);
    ComaXM1 = CARTES_2DZER(ZernM1,7,nRes,masq_telM1);
    ComaYM1 = CARTES_2DZER(ZernM1,8,nRes,masq_telM1);
end
...
if ROUT == 3
    REP_M1 = 'C:\Users\mgray\AO_HARMONI\RESULTATS\';
    ...
    PistonSeg = CARTES_2DZER(ZernSeg,1,lg_DhexaPix,masq_hexa);
    TipSeg = CARTES_2DZER(ZernSeg,2,lg_DhexaPix,masq_hexa);
    TiltSeg = CARTES_2DZER(ZernSeg,3,lg_DhexaPix,masq_hexa);
    npix = nnz(PistonSeg);
...
if ROUT == 4
    ...
    telM1 = telescope(DiamExtNonVig,'obstructionRatio',0,'resolution',nRes,'samplingTime',1/500);
    masq_telM1 = telM1.pupilLogical;
    ZernM1 = zernike(1:3,DiamExtNonVig,'resolution',nRes,'pupil',masq_telM1);
    TiltM1 = CARTES_2DZER(ZernM1,3,nRes,masq_telM1);
    % PERTURBATION ( Tilt )
