...
%         area;
    ...
    methods
        ...
        function obj = telescopeAbstract(D,varargin)
            ...
            %p.addParamValue('phaseScreenType',[],@islogical);
            ...
            p.parse(D, varargin{:});
            obj.D                = p.Results.D;
            %obj.phaseScreenType = p.Results.phaseScreenType;
...
%                     nPixel = round(1 + (obj.resolution-1)*D./Do);
                    ...
                    obj.innerMask{kLayer} =  ...
                        ...
                        'shape','square','type','logical') );
                    fprintf('            -> # of elements for the outer mask: %d and for the inner mask %d\n',...
